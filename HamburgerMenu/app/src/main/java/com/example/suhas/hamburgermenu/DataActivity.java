...
public class DataActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(userList.size()!=0){
            ...
            ListAdapter adapter = new SimpleAdapter( DataActivity.this,userList, R.layout.view_user_entry, new String[] { "userId","userName"}, new int[] {R.id.userId, R.id.userName});
    ...
    public void syncSQLiteMySQLDB(){
        ...
        if(userList.size()!=0){
            if(controller.dbSyncCount() != 0){
                ...
                client.post("http://192.168.43.109/sqlitemysqlsync/insertuser.php",params ,new AsyncHttpResponseHandler() {
                    @Override
